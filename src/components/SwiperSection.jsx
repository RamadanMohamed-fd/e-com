  ...
  return (
    ...
    className=""
      ...
      <div className=" ">
        ...
        <SwiperSlide>
         <div key={i} className=" p-1 ml-[8px] bg-slate-50 -mb-8 h-[180px] max-w-[320px] shadow-md rounded-md border-2 cursor-pointer flex">
      ...
      <div className='button-prev-slide text-3xl grid place-items-center absolute z-10 top-[44%] hover:text-[var(--color-default)] duration-200 left-0 cursor-pointer text-slate-700'><BsArrowLeftSquareFill/></div>
      <div className='button-next-slide text-3xl grid place-items-center absolute z-10 top-[44%] hover:text-[var(--color-default)] duration-200 right-6 cursor-pointer text-slate-700'><BsArrowRightSquareFill/></div>
      </Swiper>
  )
}
