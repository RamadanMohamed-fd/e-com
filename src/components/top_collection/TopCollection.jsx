 ...
 const handlr=()=>{
  ...
  <div id='top_collection' className=" py-8 w-full relative bg-white">
    ...
    className="relative"
      ...
      <div className='button-prev-slide text-3xl grid place-items-center absolute z-10 top-[40%] hover:text-[var(--color-default)] duration-200 left-0 cursor-pointer text-slate-700  '><BsArrowLeftSquareFill/></div>
      <div className='button-next-slide text-3xl grid place-items-center absolute z-10 top-[40%] hover:text-[var(--color-default)] duration-200 right-0 cursor-pointer text-slate-700'><BsArrowRightSquareFill/></div>
      </Swiper>
      <div className=' bg-[var(--color-default)]  btn  shadow-xl px-5 py-2 rounded-lg  cursor-pointer
     w-fit text-white text-xl mt-0' ><a href='#intricate_handlooms'>Explore More </a></div>
    </div>
  </div>
  )
}
