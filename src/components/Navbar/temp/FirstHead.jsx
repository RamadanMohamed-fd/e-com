...
const FirstHead = () => {
  ...
  return (
    <div className={``} >
    <div className={`flex ${offset>=300 &&" bg-slate-50 text-slate-600 h-8 z-[510]"} justify-between items-center tracking-wider px-12 py-[0px] font-normal  text-[14px] bg-[var(--color-default)] text-[var(--color-primary)]  max-[570px]:hidden`}>
