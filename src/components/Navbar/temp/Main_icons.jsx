...
const Main_icons = (props) => {
  ...
  return (
  <>
   <div className={` text-slate-500  cursor-pointer`}> <AiOutlineSearch/></div>
      <div className=" cursor-pointer p-4 relative group">
        <FaShoppingCart/>
        <span className="bg-[var(--color-default)] left-7 text-sm top-3 absolute h-5 flex justify-center items-center text-white 
      ...
      <div className="p-4 cursor-pointer  group/i  relative ">
        <AiFillSetting/>
        <div className={` absolute z-[106]  -right-4 opacity-0 ${props.className}`}>
